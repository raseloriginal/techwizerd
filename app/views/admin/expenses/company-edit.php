<?php $title = 'Edit Company Expense'; ?>
...
<div class="flex items-center gap-2 mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-800 m-0">Edit Company Expense</h2>
</div>

<form action="<?= base_url('admin/expenses/company/edit/' . $expense['id']) ?>" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 max-w-4xl">
    <?= csrf_field() ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 border-b border-gray-100 pb-6">
        ...
        <div class="form-group mb-0">
            ...
            <input type="text" id="fiscal_year" name="fiscal_year" class="form-control" value="<?= h($expense['fiscal_year']) ?>">
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div class="form-group mb-0">
            ...
            <input type="number" step="0.01" id="amount" name="amount" class="form-control font-mono text-lg text-blue-600 font-bold" required value="<?= h($expense['amount']) ?>">
        </div>
    ...
    <div class="form-group mb-8">
        ...
        <input type="file" name="receipt" class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" accept=".jpg,.jpeg,.png,.pdf">
    </div>
